...
const HowThisWork = () => (
    ...
    <div className="gallie__HowThisWork section__margin">
        ...
        <div className="gallie__HowThisWork-container">
            <h3 className="gradient__text gallie__HowThisWork-head-text">Looking for animal care?</h3>
        ...
        <div className="gallie__HowThisWork-container">
                <h3 className="gradient__text gallie__HowThisWork-head-text">Want a pet sitter?</h3>
